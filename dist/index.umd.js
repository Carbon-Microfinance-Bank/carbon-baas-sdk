(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('util'), require('stream'), require('path'), require('http'), require('https'), require('url'), require('fs'), require('crypto'), require('http2'), require('assert'), require('tty'), require('os'), require('zlib'), require('events')) :
  typeof define === 'function' && define.amd ? define(['exports', 'util', 'stream', 'path', 'http', 'https', 'url', 'fs', 'crypto', 'http2', 'assert', 'tty', 'os', 'zlib', 'events'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["carbon-baas-sdk"] = {}, global.require$$1, global.stream, global.require$$1$1, global.require$$3, global.require$$4, global.require$$0$1, global.require$$6, global.require$$8, global.http2, global.require$$4$1, global.require$$1$2, global.require$$0$2, global.zlib, global.events));
})(this, (function (exports, require$$1, stream, require$$1$1, require$$3, require$$4, require$$0$1, require$$6, require$$8, http2, require$$4$1, require$$1$2, require$$0$2, zlib, events) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  function createAccount(accountData) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().post('/v1/accounts', accountData);
  ...
  function fetchAccount(accountNumber) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().get(`/v1/accounts/${accountNumber}`);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function verifyTransaction(accountNumber, reference) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().get(`/v1/accounts/${accountNumber}/transactions/${reference}`);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function fetchTransactions(accountNumber_1) {
      return __awaiter(this, arguments, void 0, function* (accountNumber, page = 1, limit = 10) {
          try {
              const response = yield getInstance().get(`/v1/accounts/${accountNumber}/transactions`, {
                  params: { page, limit },
              });
              return response.data;
          }
  ...
  function createCustomer(customerData) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().post('/v1/customers', customerData);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function fetchCustomer(customerId) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().get(`/v1/customers/${customerId}`);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function initiatePayout(payoutData) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().post('/v1/payouts', payoutData);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function fetchBanks() {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().get('/v1/banks');
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function resolveAccount(accountData) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().post('/v1/banks/resolve', accountData);
              return response.data;
          }
          catch (error) {
              return handleError(error);
  ...
  function fetchWebhookHistory() {
      return __awaiter(this, arguments, void 0, function* (page = 0, limit = 10) {
          try {
              const response = yield getInstance().get('/v1/webhook/history', {
                  params: { page, limit },
              });
              return response.data;
          }
  ...
  function resendWebhookEvent(eventId) {
      return __awaiter(this, void 0, void 0, function* () {
          try {
              const response = yield getInstance().post('/v1/webhook/resend-webhook-event', {
                  event_id: eventId,
              });
              return response.data;
          }
  ...
  exports.calculateRepayment = calculateRepayment;
  exports.chargeRepayment = chargeRepayment;
  ...
  exports.getActiveLoan = getActiveLoan;
  exports.getBankStatementStatus = getBankStatementStatus;
  exports.getCustomerKycStatus = getCustomerKycStatus;
  ...
  exports.listLoanApplications = listLoanApplications;
  exports.listSupportedStatementBanks = listSupportedStatementBanks;
  exports.merchantFeeCharge = merchantFeeCharge;
  exports.postOfferKyc = postOfferKyc;
  exports.requestBankStatement = requestBankStatement;
  exports.resendWebhookEvent = resendWebhookEvent;
  exports.resolveAccount = resolveAccount;
  exports.setDisbursementAccount = setDisbursementAccount;
  exports.startDecisioning = startDecisioning;
  exports.submitUnderwriting = submitUnderwriting;
  exports.uploadBoardResolution = uploadBoardResolution;
  exports.uploadLoanDocument = uploadLoanDocument;
  exports.verifyCustomerKyc = verifyCustomerKyc;
